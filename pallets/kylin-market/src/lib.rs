...
use kylin_primitives::nft::{AccountIdOrCollectionNftTuple, NftInfo};
        ...
        T: pallet_uniques::Config<CollectionId = CollectionId, ItemId = NftId>,
    {
        ...
        pub fn unlist(
            ...
            // Check if NFT is still in ListedNfts storage
                ...
                Self::is_nft_listed(collection_id, nft_id),
                Error::<T>::CannotUnlistToken
            );
            let owner = pallet_uniques::Pallet::<T>::owner(collection_id, nft_id)
                .ok_or(Error::<T>::TokenDoesNotExist)?;
        ...
        pub fn make_offer(
            ...
            // Ensure amount is above the minimum threshold
                ...
                amount >= T::MinimumOfferAmount::get(),
                Error::<T>::OfferTooLow
            );
