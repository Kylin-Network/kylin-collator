...
//! Autogenerated weights for kylin_democracy
//!
...
/// Weight functions needed for kylin_democracy.
...
/// Weights for kylin_democracy using the Substrate node and recommended hardware.
