#!/usr/bin/env bash
#Key（密钥）	Value（值）
#Secret phrase（助记词）	clip organ olive upper oak void inject side suit toilet stick narrow
#Secret seed	0x4bd2b2c1dad3dbe3fa37dc6ad5a4e32ddd8ad84b938179ac905b0622880e86e7
#SR25519
#Public key（公钥）	0x9effc1668ca381c242885516ec9fa2b19c67b6684c02a8a3237b6862e5c8cd7e
#SS58 Address	5FfBQ3kwXrbdyoqLPvcXRp7ikWydXawpNs2Ceu3WwFdhZ8W4
#ED25519
#Public key（公钥）	0xb48004c6e1625282313b07d1c9950935e86894a2e4f21fb1ffee9854d180c781
